...
namespace CalculatorTest
{
    ...
    public class ScenarioStandard : CalculatorSession
    {
        ...
        public void Addition()
        {
            ...
            AppiumWebElement weUColors= Ucolors2.FindElementByAccessibilityId("lblStatus");
        ...
        //    session.FindElementByXPath("//Button[@AutomationId=\"multiplyButton\"]").Click();
        //    session.FindElementByXPath("//Button[@AutomationId=\"num9Button\"]").Click();
        ...
        public void Clear()
        {
            //session.FindElementByName("Cancella").Click();
        ...
        private string GetCalculatorResultText()
        {
            ...
            return calculatorResult.Text.Replace("Lo schermo è", string.Empty).Trim();
        }
    }
}
